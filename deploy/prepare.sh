...
[ -z ${service} ] && service=volume-initializer
[ -z ${secret} ] && secret=volume-initializer-certs
...
kubectl -n ${namespace} delete secret volume-initializer --ignore-not-found=true
...
kubectl -n ${namespace} create secret tls volume-initializer \
