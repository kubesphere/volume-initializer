...
import (
	...
	"github.com/kubesphere/volume-initializer/pkg/generated/clientset/versioned/scheme"
...
func (c *StorageV1alpha1Client) Initializers() InitializerInterface {
	return newInitializers(c)
}
